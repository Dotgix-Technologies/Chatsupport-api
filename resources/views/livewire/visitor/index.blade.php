...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('vendor/chatsupport/visitor/index.css') }}">
                    ...
                    <div class="chatbox-index-aass">
                        <div class="chatbox-index-conversations">
                            ...
                            @if ($conversation)
                                @if ($conversation->visitorunreadMessagesCount() > 0)
                                    <button class="count-button">
                                        {{ $conversation->visitorunreadMessagesCount() }}</button>
                                @endif
                            ...
                            <button class="new-convo-btn" wire:click="showChatBox">
                                <svg width="32" height="32" viewBox="0 0 1024 1024" class="icon"
                                    version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#ffffff"
                                    stroke="#ffffff">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round">
                                    </g>
